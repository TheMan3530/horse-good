...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Greetings FNF modding community, it appears that we meet again."
			+ "\nWe hope you enjoy the mod, we put quite a bit of time into it,"
			+ "\n\nand a lot more effort than our previous submission, Vs. Porky"
			+ "\n\nAlso, when your done the main week, check freeplay. There's a cool secret for you."
			+ "\n\nThere's also a number of secret songs that can be found in various places."
			+ "\n\nCan't find them? There's a cheat sheet in the files to help you."
