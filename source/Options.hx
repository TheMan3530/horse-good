...
class NoMessage extends Option
{
	public static var message:Bool = true;
	...
	public override function press():Bool
	{
		message = FlxG.save.data.noMessage;
		
		FlxG.save.data.noMessage = !FlxG.save.data.noMessage;
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.noMessage ? "Show the message when you open the game" : "Dont show the message";
	}
